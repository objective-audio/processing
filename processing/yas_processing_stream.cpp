...
proc::stream::stream(proc::sync_source sync_src)
    : base(std::make_shared<impl>(std::move(sync_src))) {}
...
proc::channel const &
proc::stream::channel(channel_index_t const channel) const {
