...
proc::channel::channel(events_map_t events) : base(std::make_shared<impl>(std::move(events))) {
}
...
proc::signal_event::pair_t proc::channel::combine_signal_event(time::range const &insert_range, signal_event signal) {
