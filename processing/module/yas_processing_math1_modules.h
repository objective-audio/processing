...
template <typename T> module make_signal_module(math1::kind const);

template <typename T> module make_number_module(math1::kind const);
} // namespace yas::proc

namespace yas {
void connect(proc::module &, proc::math1::input const &,
             proc::channel_index_t const &);
void connect(proc::module &, proc::math1::output const &,
             proc::channel_index_t const &);
