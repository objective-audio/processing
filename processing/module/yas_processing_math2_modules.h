...
template <typename T> module make_signal_module(math2::kind const);

template <typename T> module make_number_module(math2::kind const);
} // namespace yas::proc

namespace yas {
void connect(proc::module &, proc::math2::input const &,
             proc::channel_index_t const &);
void connect(proc::module &, proc::math2::output const &,
             proc::channel_index_t const &);
