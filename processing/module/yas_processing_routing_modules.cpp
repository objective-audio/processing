...
proc::module proc::make_signal_module(proc::routing::kind const kind) {
  ...
  auto prepare_processor =
      [context](time::range const &, connector_map_t const &,
                connector_map_t const &, stream &stream) mutable {
        context->reset(stream.sync_source().slice_length);
      };

  auto receive_processor = proc::make_receive_signal_processor<T>(
      [context](time::range const &time_range, sync_source const &,
  ...
  auto send_processor = proc::make_send_signal_processor<T>(
      [context, kind, out_each = fast_each<T *>{}](
        ...
        if (co_idx == to_connector_index(output::value)) {
          ...
          auto const src_offset =
              input_time
                  ? time_range.frame - input_time.get<time::range>().frame
                  : 0;
          auto const &src_length =
              input_time ? input_time.get<time::range>().length : 0;
          ...
          while (yas_each_next(out_each)) {
            ...
            auto const &src_value =
                (src_idx >= 0 && src_idx < src_length) ? src_ptr[src_idx] : 0;
  ...
  if (kind == kind::move) {
    auto remove_processor = proc::make_remove_signal_processor<T>(
        {to_connector_index(input::value)});
...
template proc::module
proc::make_signal_module<double>(proc::routing::kind const);
template proc::module
proc::make_signal_module<float>(proc::routing::kind const);
template proc::module
proc::make_signal_module<int64_t>(proc::routing::kind const);
template proc::module
proc::make_signal_module<int32_t>(proc::routing::kind const);
template proc::module
proc::make_signal_module<int16_t>(proc::routing::kind const);
template proc::module
proc::make_signal_module<int8_t>(proc::routing::kind const);
template proc::module
proc::make_signal_module<uint64_t>(proc::routing::kind const);
template proc::module
proc::make_signal_module<uint32_t>(proc::routing::kind const);
template proc::module
proc::make_signal_module<uint16_t>(proc::routing::kind const);
template proc::module
proc::make_signal_module<uint8_t>(proc::routing::kind const);
template proc::module
proc::make_signal_module<boolean>(proc::routing::kind const);
...
proc::module proc::make_number_module(routing::kind const kind) {
  ...
  auto prepare_processor =
      [context](time::range const &current_range, connector_map_t const &,
  ...
  auto receive_processor = make_receive_number_processor<T>(
      [context](proc::time::frame::type const &frame, channel_index_t const,
  ...
  auto send_processor = make_send_number_processor<T>(
      [context, kind](proc::time::range const &, sync_source const &,
                      channel_index_t const,
  ...
  module::processors_t processors{prepare_processor, receive_processor};
  if (kind == kind::move) {
    auto remove_processor = proc::make_remove_number_processor<T>(
        {to_connector_index(input::value)});
    processors.emplace_back(std::move(remove_processor));
  }
  processors.emplace_back(std::move(send_processor));
...
template proc::module
proc::make_number_module<double>(proc::routing::kind const);
template proc::module
proc::make_number_module<float>(proc::routing::kind const);
template proc::module
proc::make_number_module<int64_t>(proc::routing::kind const);
template proc::module
proc::make_number_module<int32_t>(proc::routing::kind const);
template proc::module
proc::make_number_module<int16_t>(proc::routing::kind const);
template proc::module
proc::make_number_module<int8_t>(proc::routing::kind const);
template proc::module
proc::make_number_module<uint64_t>(proc::routing::kind const);
template proc::module
proc::make_number_module<uint32_t>(proc::routing::kind const);
template proc::module
proc::make_number_module<uint16_t>(proc::routing::kind const);
template proc::module
proc::make_number_module<uint8_t>(proc::routing::kind const);
template proc::module
proc::make_number_module<boolean>(proc::routing::kind const);
