...
template <typename T>
proc::processor_f
proc::make_send_signal_processor(proc::send_signal_process_f<T> handler) {
  return [handler = std::move(handler)](
             time::range const &current_time_range, connector_map_t const &,
    ...
    if (handler) {
      for (auto const &connector_pair : output_connectors) {
        ...
        channel.insert_event(time{current_time_range},
                             signal_event{std::move(vec)});
      }
    }
  };
...
proc::make_send_signal_processor(proc::send_signal_process_f<double>);
template proc::processor_f
proc::make_send_signal_processor(proc::send_signal_process_f<float>);
template proc::processor_f
    proc::make_send_signal_processor(proc::send_signal_process_f<int64_t>);
template proc::processor_f
    proc::make_send_signal_processor(proc::send_signal_process_f<int32_t>);
template proc::processor_f
    proc::make_send_signal_processor(proc::send_signal_process_f<int16_t>);
template proc::processor_f
    proc::make_send_signal_processor(proc::send_signal_process_f<int8_t>);
template proc::processor_f
    proc::make_send_signal_processor(proc::send_signal_process_f<uint64_t>);
template proc::processor_f
    proc::make_send_signal_processor(proc::send_signal_process_f<uint32_t>);
template proc::processor_f
    proc::make_send_signal_processor(proc::send_signal_process_f<uint16_t>);
template proc::processor_f
    proc::make_send_signal_processor(proc::send_signal_process_f<uint8_t>);
template proc::processor_f
    proc::make_send_signal_processor(proc::send_signal_process_f<boolean>);
