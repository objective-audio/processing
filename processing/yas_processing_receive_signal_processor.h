...
namespace processing {
    template <typename T>
    using receive_signal_process_f =
        std::function<void(processing::time::range const &, sync_source const &, channel_index_t const,
                           connector_index_t const, T const *const)>;
