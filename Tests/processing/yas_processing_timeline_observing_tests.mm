//
//  yas_processing_timeline_observing_tests.mm
//

#import <XCTest/XCTest.h>
#import <processing/timeline/yas_processing_timeline.h>

using namespace yas;
using namespace yas::proc;

@interface yas_processing_timeline_observing_tests : XCTestCase

@end

@implementation yas_processing_timeline_observing_tests
