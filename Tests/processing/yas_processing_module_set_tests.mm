//
//  yas_processing_module_set_tests.mm
//

#import <XCTest/XCTest.h>
#import <processing/module/yas_processing_module.h>
#import <processing/module_set/yas_processing_module_set.h>

using namespace yas;
using namespace yas::proc;

@interface yas_processing_module_set_tests : XCTestCase

@end

@implementation yas_processing_module_set_tests
