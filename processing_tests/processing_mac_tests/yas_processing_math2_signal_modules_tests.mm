...
- (void)test_plus_process {
  ...
  auto stream = test::make_signal_stream(time::range{0, process_length},
                                         left_data, time::range{1, 2}, 0,
                                         right_data, time::range{2, 2}, 1);
...
- (void)test_atan2 {
  ...
  auto stream = test::make_signal_stream(time::range{0, process_length},
                                         left_data, time::range{1, 6}, 0,
                                         right_data, time::range{2, 6}, 1);
