...
- (void)test_process {
    ...
    num_to_sig_module.connect_input(to_connector_index(number_to_signal::input_key::in), in_ch_idx);
    num_to_sig_module.connect_output(to_connector_index(number_to_signal::output_key::out), out_ch_idx);
