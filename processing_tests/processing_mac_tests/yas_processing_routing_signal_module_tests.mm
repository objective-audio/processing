...
- (void)test_move_signal_process {
  ...
  auto stream = test::make_signal_stream(time::range{0, process_length}, data,
                                         time::range{0, process_length}, 0);
  ...
  auto const signal = cast<proc::signal_event>(output_events.cbegin()->second);
...
- (void)test_move_signal_process_part {
  ...
  module.connect_output(to_connector_index(routing::output::value),
                        output_ch_idx);
  ...
  auto const unprocessed_signal =
      cast<proc::signal_event>(unprocessed_events.cbegin()->second);
  ...
  auto const processed_signal =
      cast<proc::signal_event>(processed_events.cbegin()->second);
...
- (void)test_copy_signal_process {
  ...
  auto const input_signal =
      cast<proc::signal_event>(input_events.cbegin()->second);
  ...
  auto const output_signal =
      cast<proc::signal_event>(output_events.cbegin()->second);
