//
//  yas_processing_track_observing_tests.mm
//
...
@interface yas_processing_track_observing_tests : XCTestCase

@end

@implementation yas_processing_track_observing_tests
...
- (void)test_push_back_and_erase_same_range {
    ...
    XCTAssertEqual(std::get<2>(event_types.at(0)), time::range(0, 1));
    XCTAssertEqual(std::get<3>(event_types.at(0)), std::nullopt);
    ...
    XCTAssertEqual(std::get<1>(event_types.at(1))->size(), 2);
    XCTAssertEqual(std::get<1>(event_types.at(1))->at(0), module1);
    XCTAssertEqual(std::get<1>(event_types.at(1))->at(1), module2);
    XCTAssertEqual(std::get<2>(event_types.at(1)), time::range(0, 1));
    XCTAssertEqual(std::get<3>(event_types.at(1)), module_set_event_type::inserted);

    track->erase_module(module1);

    XCTAssertEqual(event_types.size(), 3);
    XCTAssertEqual(std::get<0>(event_types.at(2)), track_event_type::relayed);
    XCTAssertEqual(std::get<1>(event_types.at(2))->size(), 1);
    XCTAssertEqual(std::get<1>(event_types.at(2))->at(0), module2);
    XCTAssertEqual(std::get<2>(event_types.at(2)), time::range(0, 1));
    XCTAssertEqual(std::get<3>(event_types.at(2)), module_set_event_type::erased);
    ...
    XCTAssertEqual(std::get<1>(event_types.at(3))->size(), 1);
    XCTAssertEqual(std::get<1>(event_types.at(3))->at(0), module2);
    XCTAssertEqual(std::get<2>(event_types.at(3)), time::range(0, 1));
    XCTAssertEqual(std::get<3>(event_types.at(3)), std::nullopt);
}
